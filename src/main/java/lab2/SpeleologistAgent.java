...
public class SpeleologistAgent extends Agent {
    ...
    private static String WORLD_DIGGER_CONVERSATION_ID = "digger-world";
    private static String NAVIGATOR_DIGGER_CONVERSATION_ID = "digger-navigator";
    ...
    private class NavigatorAgentPerformer extends Behaviour {
        ...
        private void sendShootMessage(String instruction) {
            sendMessage(instruction, SHOOT_ARROW);
        }
        ...
        private void sendMoveMessage(String instruction) {
            sendMessage(instruction, MOVE);
        }

        private void sendMessage(String instruction, int action) {
