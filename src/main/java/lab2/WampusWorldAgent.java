...
public class WampusWorldAgent extends Agent {
    ...
    private static String SERVICE_DESCRIPTION = "WAMPUS-WORLD";
    ...
    private class SpeleologistMovePerformer extends CyclicBehaviour {
        public void action() {
            ...
            if (msg != null) {
                ...
                AID current_Speleologist = msg.getSender();
                Coordinates speleologist_coordinates = Speleologists.get(current_Speleologist);
                System.out.println("World say: Current agent coords: " + speleologist_coordinates.row + " | " + speleologist_coordinates.column);
                if (speleologist_coordinates == null){
                    Speleologists.put(current_Speleologist, new Coordinates(0, 0));
        ...
        public void action() {
            ...
            if (msg != null) {
                ...
                if (speleologist_coordinates == null){
                    ...
                    if (wampusMap[speleologist_coordinates.row][speleologist_coordinates.column].events.contains(WampusWorldAgent.roomCodes.get(GOLD))){
                        ACLMessage reply = msg.createReply();
